...
public class BlockGearbox extends Block {
    ...
    private float Ratio;
    public BlockGearbox(String name, Material material, CreativeTabs tab, float maxSpeed, float maxTorque, float ratio){
        super(material);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileEntityGearbox(MaxSpeed, MaxTorque, Ratio);
    }
}
