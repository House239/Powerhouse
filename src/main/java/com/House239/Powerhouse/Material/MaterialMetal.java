...
public class MaterialMetal extends Material{
     ...
     */
    public MaterialMetal(String name, Color color, int iconset, String modid, int meltingPoint, String translationKey, String chemicalFormula, int tier, float hardness, float blastres) {
